                    ...
                    <form action="{{route('admin.countries.update', $country)}}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-7 mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg border-2 shadow-none"
                                    value="{{$country->name}}" name="name" id="name" placeholder="Es: Italia, Giappone, Islanda..." required>
                                @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" class="form-control border-2 shadow-none" id="description" rows="5"
                                placeholder="Scrivi una breve introduzione al paese...">{{$country->description}}</textarea>
