...
<div class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="fw-bold text-dark mb-1">Crea Nuovo Paese</h1>
            <p class="text-muted">Inserisci le informazioni di base per registrare una nuova nazione nel sistema.</p>
        </div>
        <a href="{{route('admin.countries.index')}}" class="btn btn-outline-secondary px-3 shadow-sm">
            ...
            <form action="{{route('admin.countries.store')}}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-7 mb-4">
                        <label for="name" class="form-label fw-bold">Nome del Paese</label>
                    ...
                    <div class="col-md-5 mb-4">
                        <label for="continent" class="form-label fw-bold">Continente</label>
